...
- "whitelist": add or remove email sender to/from whitelist
...
For "whitelist": include "action": "add|remove", "email", and "label" (label only needed for add)
...
[{"intent": "whitelist", "content": "add doctor@clinic.com", "action": "add", "email": "doctor@clinic.com", "label": "Medical", "tags": []},
