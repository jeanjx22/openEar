...
class SenderAdapter(
    private val onDelete: (AllowedSender) -> Unit
) : RecyclerView.Adapter<SenderAdapter.ViewHolder>() {

    private val items = mutableListOf<AllowedSender>()
    ...
    fun setItems(newItems: List<AllowedSender>) {
        items.clear()
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvLabel.text = sender.label
